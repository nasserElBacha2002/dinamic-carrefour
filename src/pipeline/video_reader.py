...
class VideoFrameReader:
    ...
    def __init__(
        ...
        Args:
            ...
            fps_extraccion: FPS objetivo para extracción (ej: 1.0 = 1 frame por segundo).
            rotar: Rotación opcional en grados (90, 180, 270).
        """
    ...
    def iter_frames(self) -> Iterator[Tuple[int, float, np.ndarray]]:
        ...
        while True:
            ...
            if idx % step == 0:
                ...
                frame = self._aplicar_rotacion(frame)
    ...
    def _aplicar_rotacion(self, frame: np.ndarray) -> np.ndarray:
